...
for(var i=0; i<hashtable.list.length; i++){
    if(hashtable.list[i].length == 1){
        console.log("(Bucket) "+ i +" (First Key) "+ hashtable.list[i] +" (First Value) " + hashtable.list[i][1]);
    }else if(hashtable.list[i].length == 2){
        console.log("(Bucket) "+ i +" (First Key) "+ hashtable.list[i] +" (First Value) " + hashtable.list[i][1] + " (Second Key) "+ hashtable.list[i] +" (Second Value) " + hashtable.list[i][1]);
    }else{
