...
function calculate(input) {
    ...
    while (!input.isEmpty()) {
        ...
        if (temp == " " && input.front() == " ")
            ...
            // if(temp==undefined){
            //     throw 'expression length has some problem'
            // }
            ...
            while (calstack.top() == " ") {
                ...
                //console.log(calstack.top());
                calstack.pop();
                //console.log('-----');
                //console.log(calstack.pop());
            }
            var change = "";
            while (calstack.top() != " " && calstack.top() != undefined) {
                ...
                change += x;
                //console.log(change);
                //if(calstack.top()==undefined){
                // throw 'expression have some problem'
                //}
            }
...
prompt.get(["Enter infix expression"], function (err, res) {
    ...
    //console.log(infixinput.arr.join(""))
    console.log("The input infix expression is <'POW' is replaced by 'P'>: ", infixinput.arr.join(""));
    ...
    //console.log("Your expression answer is: " + );
    ...
    result.on("line", function (input) {
        if (input == "quit" || input == "Quit" || input == "Q" || input == "q")
            ...
            console.log("The input infix expression is <'POW' is replaced by 'P'>: ", change.arr.join(""));
            after = transfer(change);
            console.log("The postfix expression is: ", after.arr.join(""));
            //console.log("The postfix expression is: ",solvePostfix(after))

            let answer = calculate(after);
            !(answer==null) ? console.log("Your expression answer is: " + answer) : console.log("Your expression have some problem");
            //wrong 
            //console.log("Your expression answer is: " + rpn(after.arr.join("")));
